[![aio-libs][aio-libs-logo]][aio-libs]

# Contributing to the [aio-libs] projects

<!-- sphinx-inclusion-post-this-line -->

This is a [aio-libs] project. By contributing you agree to abide by the
[Contributor Code of Conduct][coc] and follow the organization-global
and project-local guidelines.

## Project Contribution Guidelines

Individual projects have their own contribution guidelines. Please, read
them before interacting in any community-related spaces.
...
When interacting in [aio-libs] spaces (issues, pull requests, matrix,
etc.), do not use LLMs to speak for you, except for translation or
grammar edits.
This includes the creation of change logs and pull request descriptions.
...
[aio-libs-logo]: https://docs.aiohttp.org/en/stable/_static/aiohttp-plain.svg
[coc]: https://github.com/aio-libs/.github/?tab=coc-ov-file
[`good first issue` label]:
https://github.com/search?q=org%3Aaio-libs+label%3A%22good+first+issue%22&type=issues
